...
export default function ContactFormCard() {
  ...
  useEffect(() => {
    if (whatsappContacts.length > 0 && donorsRef.current) {
      donorsRef.current.scrollIntoView({ behavior: "smooth", block: "start" });
    }
  }, [whatsappContacts]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-slate-100 flex items-center justify-center p-2">
      {/* Main Card Container */}
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden w-full max-w-lg transform hover:scale-[1.02] transition-all duration-300">
        {/* Header Section */}
        <div className="relative bg-gradient-to-r from-slate-800 via-slate-900 to-orange-900 p-4">
          ...
          <div className="relative z-10">
            ...
            <p className="text-orange-200 text-xs font-medium">TECHNONEXT</p>
          </div>
        </div>
        ...
        <div className="p-4">
          <div className="space-y-4">
                ...
                <select
                  ...
                  className={`block w-full pl-10 pr-3 py-3 border-2 text-slate-800 bg-white/50 backdrop-blur-sm ${
                    errors.bloodGroup
                      ? "border-red-400 focus:border-red-500"
                      : "border-slate-200 focus:border-orange-400"
                  } rounded-xl focus:ring-2 focus:ring-orange-100 focus:outline-none transition-all duration-200 appearance-none cursor-pointer text-sm`}
                >
            ...
            <div className="group">
              ...
              <textarea
                ...
                className={`block w-full p-3 border-2 text-slate-800 bg-white/50 backdrop-blur-sm ${
                  errors.message
                    ? "border-red-400 focus:border-red-500"
                    : "border-slate-200 focus:border-orange-400"
                } rounded-xl focus:ring-2 focus:ring-orange-100 focus:outline-none transition-all duration-200 resize-none placeholder:text-slate-400 text-sm`}
              ></textarea>
              {errors.message && (
                <p className="mt-1 text-xs text-red-500 flex items-center space-x-1">
                  <span className="w-3 h-3 text-red-500">⚠</span>
            ...
            <button
              ...
              } text-white py-3 px-4 rounded-xl font-bold shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-orange-200 transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 relative overflow-hidden group`}
            >
              <span className="relative z-10 flex items-center justify-center space-x-2">
                ...
                <span className="text-sm">
                  {isLoading ? "Searching Donors..." : "Find Donors"}
                </span>
              </span>
              {!isLoading && (
          ...
          {whatsappContacts.length > 0 && (
            ...
            >
              ...
              <div className="space-y-2">
                {whatsappContacts.map((contact, index) => (
                  <a
                    ...
                    className="flex items-center justify-between w-full p-3 bg-white border border-green-200 rounded-lg hover:bg-green-50 hover:border-green-300 transition-all duration-200 transform hover:scale-[1.02] group"
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-green-500 group-hover:translate-x-1 transition-transform duration-200"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <button
                onClick={resetForm}
                className="w-full mt-2 bg-slate-100 hover:bg-slate-200 text-slate-700 py-2 px-3 rounded-lg font-medium transition-all duration-200 border border-slate-200 text-sm"
              >
                Submit New Request
              </button>
            </div>
